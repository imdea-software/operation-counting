...
of the $\<pop>=>3$ operation (from the first thread) or the order between the return action of the $\<push>(3)$ operation and
the return action of the $\<pop>=>3$ operation has the same history $h$. 
