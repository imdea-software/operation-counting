...
\] 
where the call to $m_2$ is pending.
%(i.e., there exists no return action matching the call action $\tup{m_2,o_2}$). 
...
executions:
\[
\tup{m_1,o_1}\tup{o_1,m_1}\mbox{ or }\tup{m_1,o_1}\tup{m_2,o_2}\tup{o_1,m_1}\tup{o_2,m_2}.
\]
