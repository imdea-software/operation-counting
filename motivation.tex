...
A method call is abstracted by a call and a return action; the internal actions of the library are abstracted by bolded edges since they are not visible to the client  
