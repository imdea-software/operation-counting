...
conform to programmers' expectations of an stack object whose operations
...
Figure~\ref{fig:treiber} and an atomic lock-based implementation, since {\tt y
= 1; x = 3; z = EMPTY} is observable using the {\tt CAS}-based implementation,
yet not using the atomic one.
