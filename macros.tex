...
\newcommand{\synop}[3]{{#1}({#2})\triangleright {#3}}
\newcommand{\synopses}[1]{\<Synopses>({#1})}
...
\mathfn{past}
\metalangkeyword{print,sync,read,write,assume,finished,time,barriers,read,write,w,r,reg,tick,newPast,counters,startTime,Shift,foreach,rem,add,isRead,DiffVal}
