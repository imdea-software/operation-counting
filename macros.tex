...
\newcommand{\nbbarr}[1]{\mbox{\#}\<barriers>({#1})}
\newcommand{\nbbarrA}[2]{\mbox{\#}\<barriers>({#1},{#2})}
\newcommand{\counting}[2]{\mbox{\#}{#1}({#2})}
\newcommand{\atLib}[1]{\mathit{At}[{#1}]}
...
\metalangkeyword{method,op}
\mathfn{past}
\metalangkeyword{print,sync,read,write,assume,finished,time,barriers,read,write,w,r}
