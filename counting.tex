...
By the equivalences of \S~\ref{sec:lin}, checking whether a given history
...
latter in \S~\ref{sec:containers}--\ref{sec:exp}.
...
demonstrate in the following; \S~\ref{sec:counting:monitor} describes a
