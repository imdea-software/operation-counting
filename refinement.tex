...
%\alert{(call and return actions do not modify the state of the library)}. 
Our technical
...
\begin{example}\label{ex:atomic_stack}
  ...
  \end{itemize}
  The lock-based stack implementation mentioned in Section~\ref{sec:motivation} is an atomic
  stack.
